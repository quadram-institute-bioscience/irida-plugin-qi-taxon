 ...
 */
public class QITaxonPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType QI_TAXON = new AnalysisType("QI_TAXON");

	public QITaxonPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
